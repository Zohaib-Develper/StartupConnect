...
function AdminDashboard() {
  ...
  return (
    <div className="page-wrapper" style={{ paddingTop: '100px' }} id="admin-dashboard">
            ...
            <div className="glass-card p-4 animate-fade-in-up delay-2">
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <small style={{ color: 'var(--text-muted)' }}>Total Projects</small>
                </div>
              </div>
            </div>
          </div>
                ...
                <table className="table table-dark-custom table-hover align-middle">
                  <thead>
                    <tr>
                      ...
                      <th className="text-end" style={{ color: 'var(--text-secondary)' }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {users.map((u) => (
            ...
            {activeTab === 'projects' && (
              <div className="table-responsive">
                <table className="table table-dark-custom table-hover align-middle">
                  <thead>
                    <tr>
                      <th style={{ color: 'var(--text-secondary)' }}>Project</th>
                      <th style={{ color: 'var(--text-secondary)' }}>Category</th>
                      <th style={{ color: 'var(--text-secondary)' }}>Founder</th>
                  ...
                  <tbody>
                    {projects.map((p) => (
                      <tr key={p.id}>
                        ...
                        <td style={{ color: 'var(--text-muted)' }}>{p.founderName}</td>
                        <td>
                          <span
                            className={`badge ${
                              p.status === 'funded' ? 'badge-status-funded' : 'badge-status-active'
                            }`}
                          >
                            {p.status}
                          </span>

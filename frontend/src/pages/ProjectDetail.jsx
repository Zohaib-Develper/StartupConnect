...
function ProjectDetail() {
    ...
    return (
      <div className="page-wrapper d-flex align-items-center justify-content-center" style={{ paddingTop: '100px' }}>
        <div className="text-center">
          ...
          <p style={{ color: 'var(--text-secondary)' }}>The project you're looking for doesn't exist.</p>
  ...
  return (
    <div className="page-wrapper" style={{ paddingTop: '100px' }} id="project-detail-page">
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8 animate-fade-in-up">
            ...
            <div className="glass-card p-4 mb-4">
              <div className="d-flex flex-wrap align-items-center gap-2 mb-3">
                ...
                >
                  {selectedProject.status === 'funded' ? '✓ Fully Funded' : '● Actively Raising'}
                </span>
              </div>

              <h1 style={{ fontWeight: 800, fontSize: '2rem', marginBottom: '0.75rem' }}>
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                  <span style={{ fontWeight: 600 }}>{selectedProject.founderName}</span>
              ...
              <h5 style={{ fontWeight: 700, marginBottom: '1rem' }}>About this project</h5>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: '1.05rem' }}>
                {selectedProject.description}
              </p>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                This innovative project aims to disrupt the {selectedProject.category.toLowerCase()} industry 
                by providing cutting-edge solutions that address real-world challenges. With a strong team 
                and a clear vision, {selectedProject.title} is positioned to become a market leader in its space.
              </p>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                The funds raised will be allocated towards product development (40%), marketing and growth (30%), 
                operations (20%), and reserves (10%). Our roadmap includes a beta launch in Q2, full product 
                release in Q3, and international expansion in Q4.
              </p>
            </div>
            ...
            <div className="glass-card p-4">
              <h5 style={{ fontWeight: 700, marginBottom: '1rem' }}>
                <i className="bi bi-clock-history me-2" style={{ color: 'var(--primary-light)' }}></i>
                Investment History
              </h5>
              {projectInvestments.length === 0 ? (
                <p style={{ color: 'var(--text-muted)' }}>No investments yet. Be the first!</p>
              ) : (
                <div className="table-responsive">
                  <table className="table table-dark-custom table-hover align-middle">
                    <thead>
                      <tr>
                        <th style={{ color: 'var(--text-secondary)', fontWeight: 600, fontSize: '0.85rem' }}>Investor</th>
                        <th style={{ color: 'var(--text-secondary)', fontWeight: 600, fontSize: '0.85rem' }}>Amount</th>
                        <th style={{ color: 'var(--text-secondary)', fontWeight: 600, fontSize: '0.85rem' }}>Date</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <div className="col-lg-4 animate-fade-in-up delay-2">
            {/* Funding Card */}
            <div className="glass-card p-4 mb-4" style={{ position: 'sticky', top: '90px' }}>
              <h5 style={{ fontWeight: 700, marginBottom: '1.5rem' }}>Funding Progress</h5>
              ...
              <div className="text-center mb-4">
                ...
                <small style={{ color: 'var(--text-muted)' }}>
                  raised of ${(selectedProject.fundingGoal / 1000).toFixed(0)}K goal
                </small>
              </div>
              ...
              <div className="row g-3 mb-4">
                <div className="col-4 text-center">
                  <div style={{ fontWeight: 700, fontSize: '1.1rem' }}>{progress}%</div>
                ...
                <div className="col-4 text-center">
                  ...
                  <small style={{ color: 'var(--text-muted)' }}>Investors</small>
                </div>
                <div className="col-4 text-center">
                  <div style={{ fontWeight: 700, fontSize: '1.1rem', color: 'var(--accent-light)' }}>
              ...
              {isAuthenticated && user?.role === 'investor' && selectedProject.status !== 'funded' ? (
                <Link
                ...
                <Link to="/login" className="btn btn-primary-custom w-100 py-3">
                  <i className="bi bi-box-arrow-in-right me-2"></i>Sign In to Invest
                </Link>
              ) : selectedProject.status === 'funded' ? (
              ...
              <div className="mt-4 pt-3" style={{ borderTop: '1px solid var(--border-color)' }}>
                <div className="d-flex justify-content-between mb-2">
                  ...
                  <span style={{ fontWeight: 600, fontSize: '0.9rem' }}>{selectedProject.category}</span>
                </div>
                <div className="d-flex justify-content-between mb-2">
                  <span style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>Created</span>
                  <span style={{ fontWeight: 600, fontSize: '0.9rem' }}>{selectedProject.createdAt}</span>
                </div>
                <div className="d-flex justify-content-between">
                  ...
                  <span
                    style={{
                      fontWeight: 600,
                      fontSize: '0.9rem',
                      color: selectedProject.status === 'funded' ? 'var(--warning)' : 'var(--success)',
                    }}
                  >
